...
[![Version](https://img.shields.io/badge/version-2.1.8-2997ff)](CHANGELOG.md)
...
Current version: **2.1.8** · Requires **macOS 26 (Tahoe)** · Architecture overview in
...
```bash
curl -L https://github.com/sbacaro/Hydra-Soundcard/releases/download/v2.1.8/Hydra-2.1.8.pkg -o Hydra.pkg
open Hydra.pkg
```

### Manual installation

Download the [ZIP archive](https://github.com/sbacaro/Hydra-Soundcard/releases/download/v2.1.8/Hydra-2.1.8.zip) and run:

```bash
unzip Hydra-2.1.8.zip
cd Hydra-2.1.8
...
**Latest release:** [Hydra 2.1.8](https://github.com/sbacaro/Hydra-Soundcard/releases/tag/v2.1.8) · Released July 16, 2026
