...
[![Version](https://img.shields.io/badge/version-2.0.1-2997ff)](CHANGELOG.md)
...
Current version: **2.0.1** · Requires **macOS 26 (Tahoe)** · Architecture overview in
...
```bash
curl -L https://github.com/sbacaro/Hydra-Soundcard/releases/download/v2.0.1/Hydra-2.0.1.pkg -o Hydra.pkg
open Hydra.pkg
```

### Manual installation

Download the [ZIP archive](https://github.com/sbacaro/Hydra-Soundcard/releases/download/v2.0.1/Hydra-2.0.1.zip) and run:

```bash
unzip Hydra-2.0.1.zip
cd Hydra-2.0.1
...
**Latest release:** [Hydra 2.0.1](https://github.com/sbacaro/Hydra-Soundcard/releases/tag/v2.0.1) · Released July 7, 2026
