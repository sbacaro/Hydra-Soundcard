    ...
    if request.opcode2().read() == 0 {
      match request.opcode1().read() {
        ...
        0x1100 => {
          ...
          let latency = self_info.latency_ns as u32;
          let lat_b = latency.to_be_bytes();
          let content = [
            ...
            0x00, 0x00, 0x00, 0x63, /* latency: */
            lat_b[0], lat_b[1], lat_b[2], lat_b[3],
            lat_b[0], lat_b[1], lat_b[2], lat_b[3],
            lat_b[0], lat_b[1], lat_b[2], lat_b[3],
            0x01, 0x35, 0xf1, 0xb4,
            lat_b[0], lat_b[1], lat_b[2], lat_b[3],
        ...
        0x1102 => {
          ...
          let content = [
            /* number of items, 2B: */ 0x00, 0x15, 0x80, 0x20, 0x00, 0x01,
            0x80, 0x21, 0x00, 0x03, 0x00, 0x24, 0x00, 0x01,
